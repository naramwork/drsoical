<div class="sm:p-4 md:p-8 lg:w-11/12 text-center  mx-auto">
    ...
    <div class="pt-2 bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="flex items-center justify-between	 ">
            <button onclick='Livewire.emit("openModal", "edit-hadith-modal")'
            ...
            <div class="flex items-center">
                <label for="price" class="mx-4 text-sm font-medium text-gray-700">البدء من الحديث رقم</label>
