<div>
    ...
    <div class="bg-white px-4 sm:p-6">
        <div>
            <label class="block mb-1 text-right" for="part">الحَديث الشَّريف</label>
...
<div class="flex items-center	 bg-white px-4 pb-5 ">
    ...
    @if ($contentId != 0)
        <button wire:click="$emit('updateHadith')"
        ...
        <button wire:click="$emit('deleteHadith')"
            class="h-10 px-5 m-2 text-red-100 transition-colors duration-150 bg-red-700 rounded-lg focus:shadow-outline hover:bg-red-800">حذف
        </button>

    @else
        <button wire:click="$emit('addHadith')"
